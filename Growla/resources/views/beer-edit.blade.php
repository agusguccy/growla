...
<h1 class="titulo">Editar Cerveza</h1>

        <div class="formulario-birras">
          <div class="casilleros">
          <label class="label" for="">Tipo de birra</label><br>
<input type="text" class="input" name="type" value="{{ old ('type') ?? $beer->type}}">
          </div>
          @if ($errors->has("type"))
        ...
        <div class="formulario-birras">
          ...
          <label class="label" for="">IBUs</label><br>
            <input class="input" type="number" name="IBUs" value="{{ old ('IBUs') ?? $beer->IBUs}}">
          </div>
          @if ($errors->has("IBUs"))
          <span class="invalid-feedback" role="alert">
...
<input type="number" class="input" name="alcohol_content" value="{{$beer->alcohol_content}}">
          </div>
...
<textarea class="textarea" name="description" rows="2" cols="50">{{ old ('description') ?? $beer->description}} </textarea>
          </div>
